#!/usr/bin/env python3
"""Validate the merged public/local registry and its project directories."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="repository root used when validating the merged public/local registry",
    )
    ...
    try:
        if args.registry is None:
            ...
            label = "projects.json + optional projects.local.json"
        else:
            repo_root = args.registry.resolve().parent
    ...
    print(f"Project registry is valid: {label}")
    return 0
