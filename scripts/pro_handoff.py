...
from scripts.project_registry import RegistryError, load_registry, project_record
...
def _registered_project(repo_root: Path, project_name: str) -> tuple[Path, dict]:
    try:
        entry = project_record(repo_root, project_name)
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    export_parser.add_argument("project", help="project path from the merged registry")
    ...
    import_parser.add_argument("project", help="project path from the merged registry")
    ...
    review_parser.add_argument("project", help="project path from the merged registry")
