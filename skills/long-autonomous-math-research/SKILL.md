...
5. If any mathematical target, success criterion, execution mode, authority, or
   stop condition is ambiguous, ask the user. Make zero persistent writes while
   waiting.
...
templates under `assets/`. Keep `contract.md` immutable except for explicitly
